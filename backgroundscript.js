...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    ...
    if (request.ig_user) {
        ...
        // MODIFICATION: Application directe de la licence plutôt que de vérifier
    ...
    if (request.fnc == 'openBuyScreen') {
        // Ne rien faire au lieu d'ouvrir l'écran d'achat
    }
...
var gblIgBotUser = {
    ...
    ig_users: [],
    licenses: { "growbot_license": 1 }, // Avoir toujours une licence
    actions: [{
        date: '',
        action: ''
    }],
...
var instabot_free_trial_time = 999999999999; // Valeur très grande pour toujours avoir un essai
var first_run = false;
...
// Fonction simplifiée qui définit toujours une date d'installation
function simulateLicenseCheck() {
    var installDate = "" + (today - 86400000); // Hier
    ...
    // Envoyer des informations de licence positive à toutes les tabs
    sendMessageToInstagramTabs({
